...
const AvaliacaoModal: React.FC<AvaliacaoModalProps> = ({ isOpen, onClose, pacientes, profissionais, tipo, onSave }) => {
  ...
  const applyPacienteDefaults = (p: Paciente | undefined) => {
    ...
    setForm((prev) => ({
      ...
      idade: ageYears !== undefined ? ageYears.toString() : (prev.idade || ''),
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const base = {
        ...
        endereco_comercial: form.endereco_comercial,
        queixa_principal: form.queixa_principal,
        historia_pregressa_e_atual_da_doenca: form.historia_pregressa_e_atual_da_doenca,
        habitos_de_vida: form.habitos_de_vida,
        tratamentos_realizados: form.tratamentos_realizados,
        antecedentes_pessoais_e_familiares: form.antecedentes_pessoais_e_familiares,
        outros: form.outros,
        exames_complementares: form.exames_complementares,
        objetivos: form.objetivos,
        qtd_atendimentos_provaveis: form.qtd_atendimentos_provaveis,
      ...
      if (tipo === 'fisio') {
        await onSave({
          ...base,
          exame_clinico_fisico: form.exame_clinico_fisico,
        ...
        await onSave({
          ...base,
          exame_clinico_fisico_educacional_social: form.exame_clinico_fisico_educacional_social,
          diagnostico_terapeutico_ocupacional: form.diagnostico_terapeutico_ocupacional,
          prognostico_terapeutico_ocupacional: form.prognostico_terapeutico_ocupacional,
